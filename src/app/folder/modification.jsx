    ...
    return (
        <>
            ...
            <main className="flex flex-col max-w-screen-2xl mx-auto">
                ...
                <div className="flex justify-center items-center mt-10 px-10 ">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            {/* Title + Description */}
                            <h1 className="font-semibold text-md lg:text-lg px-10">
                            ...
                            {isSpecial ? (
                                <form onSubmit={handleSubmitSpecial}>
                                    <div className="w-full px-10">
                                        <div className="flex flex-col lg:flex-row">
                                            <div className="w-full lg:flex-3 text-sm lg:text-base">
                                                <FormInput
                                                    label="Task Date"
                                                    type="date"
                                                    name="date"
                                            ...
                                            <div className="w-full lg:flex-1 text-sm lg:text-base text-center mb-5 lg:mt-9">
                                                or
                                            </div>
                                        ...
                                        {dateError && (
                                            <p className="text-red-500 text-sm text-left">{dateError}</p>
                                        )}

                                        <div className="flex flex-col lg:flex-row lg:gap-5 mt-5">
                                            <div className="w-full lg:flex-1 text-sm lg:text-base">
                                                <FormInput
                                                    label="Task Name"
                                                    type="text"
                                                    name="name"
                                        ...
                                        {specialError && <p className="text-red-500 text-sm text-left mb-5">{specialError}</p>}
                                ...
                                <form onSubmit={handleSubmitDaily}>
                                    ...
                                    {dailyError && <p className="text-red-500 text-sm text-left px-10 mb-5">{dailyError}</p>}
                ...
                {/* Modification */}
                <div className="flex flex-col lg:flex-row lg:items-start gap-10 justify-center items-center mt-10 mb-10 px-10">
                    <AnimatePresence mode="wait">
                        <motion.div
                            key={isSpecial2 ? "special-list" : "daily-list"}
                            className="relative bg-white text-black shadow-[0_0_25px_rgba(255,255,255,0.8)] rounded-2xl px-15 py-5 text-left w-full lg:w-[50%]"
                            initial={
                                hasEntered
                                    ? { opacity: 0, rotateY: isSpecial ? -90 : 90 }
                                    : { opacity: 0, y: 50 }
                                            ...
                                            <ul className="list-disc">
                                                {todos.map(({ id, name, remark, index }) => (
                                                    <li
                                                        ...
                                                        className={`group flex flex-col cursor-pointer mb-3 text-sm lg:text-base rounded-lg px-3 py-2 select-none 
                                ...
                                {selectedTask && (
                                    <>
                                        ...
                                        <form className="text-sm lg:text-base">
                                            ...
                                            />
                                            {dailyError2.name && <p className="text-red-500 text-sm text-left mb-5">{dailyError2.name}</p>}
                                            ...
                                            />
                                            {dailyError2.remark && <p className="text-red-500 text-sm text-left mb-5">{dailyError2.remark}</p>}
                                ...
                                {selectedTask2 && (
                                    <>
                                        ...
                                        <form className="text-sm lg:text-base">
                                            ...
                                            />
                                            {specialError2.date && <p className="text-red-500 text-sm text-left mb-5">{specialError2.date}</p>}
                                            ...
                                            <div className="mt-15">
                                                ...
                                                {specialError2.name && <p className="text-red-500 text-sm text-left mb-5">{specialError2.name}</p>}
                                                ...
                                                {specialError2.remark && <p className="text-red-500 text-sm text-left mb-5">{specialError2.remark}</p>}
